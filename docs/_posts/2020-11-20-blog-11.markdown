...
In this week's blog I am going to be using a pessimistic lock that would be able to lock, unlock, and manipulate any data activies. Everything I will be demonstrating will be based on this relational diagram:
<br><br>
  <center>
